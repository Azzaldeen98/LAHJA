...
namespace Infrastructure.Repository.Plans
{
    ...
    /// /////////////////////////////////////////////////////////////////////////////
        ...
        public async Task<Result<PlanResponse>> createPlanAsync(PlanCreate request)
        {
            ...
            if (response.Succeeded)
            {
                var resModel = _mapper.Map<PlanResponse>(response);

                return Result<PlanResponse>.Success(resModel);
            }
            else
            {
        ...
        public async Task<Result<PlanResponse>> updatePlanAsync(PlanUpdate request)
        {
