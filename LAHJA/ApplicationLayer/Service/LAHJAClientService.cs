...
//        public RequestClientService(Req lahjaService, IMapper mapper, TokenService tokenService, IVoiceBotService voiceBotService, IT2TService t2TService, IQueryTextToSpeechService queryTextToSpeechService)
//        {
...
//        {
//            return await _lahjaService.CreateEventAsync(request);
//        } 
//        public async Task<Result<ServiceResponse>> ResultRequestAsync(ResultRequest request)
//        {
          
//            return await _lahjaService.ResultRequestAsync(request);
//        }
//    }
